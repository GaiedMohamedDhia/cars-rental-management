    ...
    <div className="lg:hidden">
      <div className="bg-transparent p-3 flex items-center justify-between">
        <Link href="/" className="flex items-center">
          <img src="/logo.png" alt="TuniCars+" className="h-10 object-contain" />
        </Link>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <img src="/logo.png" alt="TuniCars+" className="h-9 object-contain" />
            ...
            <nav className="flex flex-col gap-3">
              ...
              <Link href="/renters" className="px-3 py-2 rounded-lg hover:bg-[rgba(255,255,255,0.02)]">👥 Locataires</Link>
